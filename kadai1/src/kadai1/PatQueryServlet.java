...
/**
 * Servlet implementation class PatQueryServlet
 */
@WebServlet("/PatQueryServlet")
public class PatQueryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(paBean.getArraysize()==0){
			...
			getServletContext().getRequestDispatcher("/PatRetrieval.jsp").forward(request, response);
